	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" >
				<video autoplay muted loop id="myVideo" width="1000" height="655" style="padding-right:100px" >
				<source src="images_login/vid-01.mp4" type="video/mp4" alt="nai aara">
				</video>
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" action="Home/Main.php">
					<span class="login100-form-title p-b-59">
					<img src="images_login/logo.png" alt="Smiley face" style="float:right;width:200px;height:100px;">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						...
						<input class="input100" type="password" name="pass" placeholder="*************" id="myInput">
						<span class="focus-input100"></span>
					</div>				
					<div class="container-login100-form-btn">
						...
						<a href="#" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							<span class="label-input100">Forgot Username/Password</span>
